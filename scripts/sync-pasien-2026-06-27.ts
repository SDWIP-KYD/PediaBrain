/**
 * Sync pasien RS Akademis — 27 Juni 2026
 * Jalanin: npx tsx scripts/sync-pasien-2026-06-27.ts
 */
...
async function main() {
  ...
  const daftarPasien: PasienInput[] = [
    ...
    { name: "Nur Ariyani",         room: "DAHLIA", bed: "K.4",  medicalRecordNo: "305489", birthDate: "13-08-2022", diagnosis: "Pneumonia",                                                     dpjp: dpjpJusli },
    { name: "Naura Khaerunnisa",   room: "DAHLIA", bed: "K.5",  medicalRecordNo: "312503", birthDate: "24-05-2021", diagnosis: "Faringitis akut, vomiting",                                       dpjp: dpjpJusli },
    { name: "Nur Syakila Syahputri",room: "DAHLIA", bed: "K.6", medicalRecordNo: "304568", birthDate: "02-06-2021", diagnosis: "Tonsilofaringitis",                                                dpjp: dpjpJusli },
    ...
    { name: "Almira Azzahra",      room: "DAHLIA", bed: "K.1",  medicalRecordNo: "312511", birthDate: "03-09-2022", diagnosis: "Faringitis akut, intake tidak terjamin",                          dpjp: dpjpSyarif },
    { name: "Muh. Alfatih Arfa",   room: "DAHLIA", bed: "K.3",  medicalRecordNo: "312463", birthDate: "29-12-2025", diagnosis: "Faringitis akut, diare akut",                                    dpjp: dpjpSyarif },
    { name: "Muh Ibnu Fatur",      room: "DAHLIA", bed: "K.7",  medicalRecordNo: "312486", birthDate: "28-06-2018", diagnosis: "Tonsilofaringitis akut",                                          dpjp: dpjpSyarif },
    ...
    { name: "Hilmansyah Shaquille",room: "ANGGREK", bed: "K.7", medicalRecordNo: "312459", birthDate: "03-09-2021", diagnosis: "Faringitis akut, diare akut, intake tidak terjamin",              dpjp: dpjpSyarif },
    { name: "Muhammad Al Fatih",   room: "ANGGREK", bed: "K.3", medicalRecordNo: "277009", birthDate: "22-11-2021", diagnosis: "Faringitis akut, intake tidak terjamin",                           dpjp: dpjpSyarif },
  ...
  console.log("╔══════════════════════════════════════════╗");
  console.log("║   SYNC PASIEN RS AKADEMIS — 27/06/2026  ║");
  console.log("╚══════════════════════════════════════════╝\n");
